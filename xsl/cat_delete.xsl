...
<xsl:template match="/">
  ...
  of the category you wish to permanently delete!</h1>
        <form  name="form1" action="cat_delete2.xsql" method="post">
          <table width="100%" height="100" border="0">
            ...
            <tr>
              <td colspan="2" align="center">
                <input type="submit" name="submitButton" value="Delete!" onclick="butCheckForm_onclick()"/>
